...
const projects = [
  ...
  },
  {
    ...
    content: [
      ...
      "My involvement on this project has included building its UI in <a href='https://angularjs.org/' target='_blank'>Angular</a> and then in <a href='https://facebook.github.io/react/' target='_blank'>React</a>. I've also been a part of developing an abstraction layer to its backend infrastructure, which is currently built on <a href='https://firebase.google.com/' target='_blank'>Firebase</a>. The long term goal with this abstraction layer is to switch out Firebase for a custom tailored solution once the MVP has proved its feasibility."
    ],
